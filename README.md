...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/royal-hall-353d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/royal-hall-353d
```

A live public deployment of this template is available at [https://royal-hall-353d.templates.workers.dev](https://royal-hall-353d.templates.workers.dev)
